...
$query = "SELECT c.*, u.Photo_user, u.Nick, u.Nombre
	FROM messageto c, user u
	WHERE c.Id_friend='$Id_friend' and c.Id_user='$Id_user' AND u.Id_user=c.Id_user
	OR (c.Id_user = '$Id_friend' AND c.Id_friend='$Id_user' AND u.Id_user=c.Id_user)
	order by c.Fecha ASC";
	$TablaComments = mysql_query($query) or die(mysql_error());
?>
